...
static const flex_int16_t yy_accept[27] =
    {   0,
        0,    0,   16,   14,   13,   13,    1,   12,    2,    3,
        6,    7,   14,   11,   11,    4,    5,    1,    0,    0,
       11,   10,    0,    8,    9,    0
    } ;
...
static const flex_int16_t yy_base[29] =
    {   0,
        0,    0,   28,   30,   30,   30,    0,   30,   30,   30,
       30,   30,   11,    0,    8,   30,   30,    0,    9,   10,
        0,    0,    9,   30,   30,   30,   26,   18
    } ;

static const flex_int16_t yy_def[29] =
    {   0,
       26,    1,   26,   26,   26,   26,   27,   26,   26,   26,
       26,   26,   26,   28,   28,   26,   26,   27,   26,   26,
       28,   28,   26,   26,   26,    0,   26,   26
    } ;

static const flex_int16_t yy_nxt[50] =
    {   0,
        4,    5,    6,    7,    8,    9,   10,   11,    4,    4,
       12,   13,    4,   14,   14,   15,   14,   16,   17,   19,
       21,   25,   24,   23,   22,   20,   18,   26,   18,    3,
...
YY_RULE_SETUP
#line 34 "string.l"
{return yytext[0];} /*acho que isso aqui n ta funcionando!!*/
	YY_BREAK
